...
description: >
  Implement a piece of work in an interactive session, following this
  repository's process: the PR rules, the review gate, and the plugin
  skills.
disable-model-invocation: true
---
Implement the work the user names, following the process below.
